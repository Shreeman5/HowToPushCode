...
def main():
    # filename = "Rainey_Dunham_1"
    # inputFileName = "CSVs/initialCSVs/"+filename+".csv"
    ...
    # df_cleaned_again = df_cleaned[df_cleaned['relative_abundance'] != 0]
    # print(df_cleaned_again)
    ...
    # outputFileName = "CSVs/CSVswithStandardRanks/"+filename+".csv"
    # df_cleaned_again.to_csv(outputFileName, index=False)
